...
# Codex Skills For Real Engineers

[![skills.sh](https://skills.sh/b/mattpocock/skills)](https://skills.sh/mattpocock/skills)

My Codex-ready agent skills that I use every day to do real engineering - not vibe coding.
...
1. Install the active skills into your local Codex skill roots:

   ```bash
   ./scripts/link-skills.sh
   ```

2. In Codex, invoke `$setup-matt-pocock-skills` once per repo. It will:
...
The repo is also packaged as a Codex plugin via [.codex-plugin/plugin.json](./.codex-plugin/plugin.json). The plugin manifest points at a filtered [.agents/skills](./.agents/skills) discovery directory so `engineering/`, `productivity/`, and `misc/` skills are promoted while `personal/`, `in-progress/`, and `deprecated/` stay private.
...
- **[guided-code-review-tour](./skills/engineering/guided-code-review-tour/SKILL.md)** — Turn a large change into a guided review route with ordered stops, risk zones, and reviewer questions.
...
- **[git-guardrails-codex](./skills/misc/git-guardrails-codex/SKILL.md)** — Set up Codex hooks to block dangerous git commands (push, reset --hard, clean, etc.) before they execute.
