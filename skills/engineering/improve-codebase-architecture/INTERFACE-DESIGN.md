...
Produce 3+ radically different interfaces for the deepened module. In Codex, spawn parallel subagents only when the user or environment explicitly permits subagent work; otherwise generate the alternatives yourself and clearly separate the constraints and trade-offs for each.
